...
catalogos_clues <- arrow::read_parquet(
  "C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/CLUES/clues.parquet"
) %>% 
...
catalogo_metas <-  readxl::read_xlsx(
  "C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Metas/2026/Metas de productividad por unidad medica 2026.xlsx"
)%>% 
  mutate(entidad = case_when(
    entidad == "MICHOACAN DE OCAMPO" ~ "Michoacan",
    entidad == "VERACRUZ DE IGNACIO DE LA LLAVE" ~ "Veracruz",
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Productividad - Cubos/Productividad de Cubos 2020-2024/Cubos_completos_2020_2024.parquet'
) AS c
...
WITH base AS (
  ...
  FROM read_parquet(
    [
      'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/consulta_externa_01_01_2024_a_31_12_2024.parquet',
      'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/planificacion_familiar_01_01_2024_a_31_12_2024.parquet',
      'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/salud_bucal_01_01_2024_a_31_12_2024.parquet',
      'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/salud_mental_01_01_2024_a_31_12_2024.parquet'
    ],
    union_by_name = true
  )
),
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/89_correciones_parquets_dn/finales procedimientos/quirurgicos 2024 nuevo.parquet'
)
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/89_correciones_parquets_dn/finales egresos/egresos 2024 nuevo.parquet'
)
...
FROM read_parquet(
  [
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/consulta_externa_01_01_2025_a_31_12_2025.parquet',
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/planificacion_familiar_01_01_2025_a_31_12_2025.parquet',
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/salud_bucal_01_01_2025_a_31_12_2025.parquet',
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/Bases originales/historicos/salud_mental_01_01_2025_a_31_12_2025.parquet'
  ],
  union_by_name = true
)
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/89_correciones_parquets_dn/finales procedimientos/quirurgicos 2025 nuevo.parquet'
)
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/89_correciones_parquets_dn/finales egresos/egresos 2025 nuevo.parquet'
)
...
df_2026_consultas <- dbGetQuery(con, glue::glue("
  ...
  FROM read_parquet(
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/78_transicion sistemas prod/data/consultas_con_ECE_2026.parquet'
  )
...
df_2026_pq <- dbGetQuery(con, glue::glue("
  ...
  FROM read_parquet(
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/78_transicion sistemas prod/data/proc_qx_con_ECE_2026.parquet'
  )
...
df_2026_egresos <- dbGetQuery(con, glue::glue("
  ...
  FROM read_parquet(
    'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/78_transicion sistemas prod/data/egresos_con_ECE_2026.parquet'
  )
...
FROM read_parquet(
  'C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Repositorio de Datos/Productividad/conteos con ece/fecha_insert_al_corte_todos.parquet'
)
...
modelo_profet <- readxl::read_xlsx(
  "C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/66_Productividad Nacional 2026/Data/profet/nowcast_todes.xlsx") %>% 
...
modelo_profet_entidad <- readxl::read_xlsx(
  "C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/66_Productividad Nacional 2026/Data/profet/nowcast_todes_estados.xlsx"
) %>% 
  transmute(fecha = as.Date(dia), tipo_consulta,
...
hbc_bajos <- readxl::read_xlsx(
  "C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/66_Productividad Nacional 2026/Data raw/cluster_11_rutas_geo_rutas_sencillo_VF23022026.xlsx"
) %>%
...
#PRESENTACION
# -------------------------------------------------------------------------
pptx <- read_pptx("C:/Users/gabriel.gomez/IMSS-BIENESTAR/División de Procesamiento de información - Comando Florence Nightingale/Proyectos/66_Productividad Nacional 2026/Data raw/Master presentación nacional.pptx")
...
print(pptx, target = paste0(
        "d:/Users/gabriel.gomez/Downloads/Reporte Nacional 2026",
        " (semana ",
         num_semana,")",".pptx"))
